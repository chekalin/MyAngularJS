...
describe('$q', function () {
    ...
    it('resolves a promise at the next digest', function () {
        var d = $q.defer();
    ...
    it('invokes a listener added after resolution', function () {
        var d = $q.defer();
        d.resolve(42);
        $rootScope.$apply();
    ...
    it('invokes a finally handler when succeeds', function () {
        var d = $q.defer();
    ...
    it('can wrap foreign promise', function () {
        var fulfilledSpy = jasmine.createSpy();
        var rejectedSpy = jasmine.createSpy();
