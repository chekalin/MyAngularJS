...
describe('$http', function () {
    ...
    it('supports functions as header values', function () {
        var contentTypeSpy = jasmine.createSpy()
    ...
    it('allow setting defaul response transforms', function () {
    ...
    it('transforms error responses too', function () {
        var response;
        $http({
            url: 'http://teropa.info',
            transformResponse: function (data) {
    ...
    it('parses JSON data from JSON responses', function () {
        var response;
        $http({
            method: 'GET',
            url: 'http://teropa.info'
    ...
    it('does not try to parse interpolation expression as JSON', function () {
        var response;
        $http({
            method: 'GET',
            url: 'http://teropa.info'
    ...
    it('attaches multiple params for arrays', function () {
        $http({
            url: 'http://teropa.info',
            params: {
                a: [42, 43]
    ...
    it('allows returning promises from request interceptors', function () {
        var injector = createInjector(['ng', function ($httpProvider) {
    ...
    it('allows aborting request after a timeout', function () {
        $http.get('http://teropa.info', {
            timeout: 5000
        });
        $rootScope.$apply();
    ...
    describe('pending requests', function () {
        ...
        it('are in collection while pending', function () {
            $http.get('http://teropa.info');
            $rootScope.$apply();
