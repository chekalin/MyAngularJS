...
describe('injector', function () {
    ...
    it('supports locals while instantiating', function () {
        var module = angular.module('myModule', []);
        module.constant('a', 1);
        module.constant('b', 2);
        var injector = createInjector(['myModule']);
    ...
    it('notifies the user about circular dependencies', function () {
        var module = angular.module('myModule', []);
        module.provider('a', {
            $get: function (b) {
            }
    ...
    it('allows injecting provider injector to provider', function () {
        var module = angular.module('myModule', []);
    ...
    it('supports running a run block from a function module', function () {
        var result = null;
        var functionModule = function ($provide) {
            $provide.constant('a', 42);
            return function (a) {
    ...
    it('allows registering factories', function () {
        var module = angular.module('myModule', []);
