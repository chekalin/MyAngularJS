...
describe("parse", function () {
    ...
    it("parses a nested attribute assignement", function () {
    ...
    it("parses several multiplicative operations", function () {
    ...
    it("still returns function when given no argument", function () {
